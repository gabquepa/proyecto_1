...
--
-- Host: localhost:8889
-- Generation Time: Aug 16, 2014 at 05:25 PM
...
(7, 'Inglés', 1, 'test.png'),
(8, 'Comunicación', 1, 'test.png'),
(9, 'Medicina', 1, 'test.png'),
(10, 'eee', 1, 'test.png');
...
(1, 3, 'este es mi primer post', ' hola test  hola test  hola test  hola test  hola test  hola test ', '2014-08-13');
...
(1, 'p', 'alvaro@ucenfotec.ac.cr', 'Álvaro ', 'Cordero Peña\n', 1, 'm', 0, '123'),
...
(5, 't', 'julian@ucenfotec.ac.cr', 'r', 'r', 1, 'r', 0, '123');
